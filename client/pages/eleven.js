...
export default function Two() {
  ...
  const updateOneScore = e => {
    playerOneScores[10] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[10] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[10] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[10] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[10] = e.target.value;
  };
  ...
  return (
    <>
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 11</h1>
      ...
      <div className={styles.buttonContainer}>
        <Button text={"Hole 11"} routePrevious="/ten" routeNext="/twelve" />
      </div>
    </>
  );
}
