...
export default function Nine() {
  ...
  const updateOneScore = e => {
    playerOneScores[8] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[8] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[8] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[8] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[8] = e.target.value;
  };
  ...
  return (
    <>
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 9</h1>
      ...
      <div className={styles.buttonContainer}>
        <Button text={"Hole 9"} routePrevious="/eight" routeNext="/ten" />
      </div>
    </>
  );
}
