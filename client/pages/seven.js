...
export default function Two() {
  ...
  const updateOneScore = e => {
    playerOneScores[6] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[6] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[6] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[6] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[6] = e.target.value;
  };
