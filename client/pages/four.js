...
export default function Four() {
  ...
  const updateOneScore = e => {
    playerOneScores[3] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[3] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[3] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[3] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[3] = e.target.value;
  };
  ...
  return (
    <>
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 4</h1>
      ...
      <div className={styles.buttonContainer}>
        <Button text={"Hole 4"} routePrevious="/three" routeNext="/five" />
      </div>
    </>
  );
}
