...
export default function Two() {
  ...
  const updateOneScore = e => {
    playerOneScores[5] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[5] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[5] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[5] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[5] = e.target.value;
  };
  ...
  return (
    <>
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 6</h1>
      ...
      <div className={styles.buttonContainer}>
        <Button text={"Hole 6"} routePrevious="/five" routeNext="/seven" />
      </div>
    </>
  );
}
