...
export default function Two() {
  ...
  const updateOneScore = e => {
    playerOneScores[13] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[13] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[13] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[13] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[13] = e.target.value;
  };
