...
export default function Two() {
  ...
  const updateOneScore = e => {
    playerOneScores[9] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[9] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[9] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[9] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[9] = e.target.value;
  };
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 10</h1>
