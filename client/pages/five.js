...
export default function Five() {
  ...
  const updateOneScore = e => {
    playerOneScores[4] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[4] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[4] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[4] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[4] = e.target.value;
  };
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 5</h1>
