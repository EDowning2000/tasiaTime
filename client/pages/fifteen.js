...
export default function Fifteen() {
  ...
  const updateOneScore = e => {
    playerOneScores[14] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[14] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[14] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[14] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[14] = e.target.value;
  };
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 15</h1>
