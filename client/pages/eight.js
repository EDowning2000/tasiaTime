...
export default function Eight() {
  ...
  const updateOneScore = e => {
    playerOneScores[7] = e.target.value;
    console.log(playerOneScores);
  };
  const updateTwoScore = e => {
    playerTwoScores[7] = e.target.value;
  };
  const updateThreeScore = e => {
    playerThreeScores[7] = e.target.value;
  };
  const updateFourScore = e => {
    playerFourScores[7] = e.target.value;
  };
  const updateFiveScore = e => {
    playerFiveScores[7] = e.target.value;
  };
  ...
  return (
    <>
        ...
        <div className={styles.firstContainer}>
          ...
          <div className={styles.center}>
            <div className={styles.center2}>
              <>
                <h1 className={styles.holeHeader}>Hole 8</h1>
      ...
      <div className={styles.buttonContainer}>
        <Button text={"Hole 8"} routePrevious="/seven" routeNext="/nine" />
      </div>
    </>
  );
}
